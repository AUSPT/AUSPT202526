...
% combine and add white gaussian noise - note - this should be set to
% 'measured' instead of -20, but we can do so later, because it creates a
% LOT of noise
raw_mixture = awgn(clean_mix, desired_SNR_dB, -20);
